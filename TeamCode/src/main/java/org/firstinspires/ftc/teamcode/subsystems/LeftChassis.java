...
public class LeftChassis extends StatePortableSubsystem {
    private DcMotor front;
    private DcMotor back;
    public LeftChassis(HardwareMap hardwareMap){
        registerSubsystem(this);
        front = hardwareMap.get(DcMotorEx.class, "frontLeft");
        back = hardwareMap.get(DcMotorEx.class, "backLeft");
        States.s1(this, -0.1);
        States.s2(this, -0.2);
